...
class OrganizationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Organization
        fields = ['name', 'id', 'temas', 'sites', 'users']

class TeamSerializer(serializers.ModelSerializer):

    projects = serializers.PrimaryKeyRelatedField(queryset=Project.objects.all(), many=True, required=False)
    sites = serializers.PrimaryKeyRelatedField(queryset=Site.objects.all(), many=True, required=False)
    users = UserSerializer(required=False, many=True, required=False)
    orgaization = OrganizationSerializer(required=False)
    org_id = serializers.IntegerField(required=False)
    
    class Meta:
        model = Team
        fields = ['name', 'id', 'users', 'sites', 'projects', 'organization', 'org_id']
...
class SiteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Site
        fields= ['id','name', 'teams', 'organization', 'org_id', 'projects']
...
class TeamProjectSerializer(serializers.ModelSerializer):
    ...
    team = TeamSerializer(require=False)
...
class OraganizationMembershipSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id','is_org_admin', 'organization', 'user', 'user_id', 'org_id']
